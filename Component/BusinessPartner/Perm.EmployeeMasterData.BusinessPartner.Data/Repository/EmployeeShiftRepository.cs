...
{
    public class EmployeeShiftRepository : Repository<EmployeeShiftModel>, IEmployeeShiftRepository
    {
        public EmployeeShiftRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
