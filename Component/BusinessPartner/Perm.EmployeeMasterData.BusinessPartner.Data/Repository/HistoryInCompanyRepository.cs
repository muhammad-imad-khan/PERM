...
{
    public class HistoryInCompanyRepository : Repository<HistoryInCompanyModel>, IHistoryInCompanyRepostory
    {
        public HistoryInCompanyRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
        }
    }
}
