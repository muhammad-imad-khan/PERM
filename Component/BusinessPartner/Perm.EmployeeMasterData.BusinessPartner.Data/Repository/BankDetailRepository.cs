...
{
    public class BankDetailRepository : Repository<EmployeeBankDetailModel>, IBankDetailRepository
    {
        public BankDetailRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
        }
    }
}
