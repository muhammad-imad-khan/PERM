...
{
    public class FeedbackRatingRepository : Repository<FeedbackRatingModel>, IFeedbackRatingRepository
    {  
        public FeedbackRatingRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
