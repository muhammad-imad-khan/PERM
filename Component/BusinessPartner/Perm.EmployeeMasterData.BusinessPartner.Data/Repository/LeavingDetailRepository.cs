...
{
    public class LeavingDetailRepository : Repository<LeavingDetailModel>, ILeavingDetailRepository
    {
        public LeavingDetailRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
        }
    }
}
