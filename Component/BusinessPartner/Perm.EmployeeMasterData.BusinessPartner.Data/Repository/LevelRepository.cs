...
{
    public class LevelRepository : Repository<LevelModel>, ILevelRepository
    {
        public LevelRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
        }
    }
}
