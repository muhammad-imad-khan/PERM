...
{
    public class HealthInsurranceRepository : Repository<HealthInsurranceModel>, IHealthInsurranceRepository
    {
        public HealthInsurranceRepository(PermDataContext dataContext, IHttpContextAccessor httpContextAccessor) : base(dataContext, httpContextAccessor)
        {
        }
    }
}
